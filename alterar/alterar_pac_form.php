...
<head>
    ...
    <title>Med Center - Editar Paciente</title>
...
<body>
    <div class="container">
        <div>
            <a href="../listagem-pac.php"><button type="submit" class="btn btn-info" style="position:absolute;top:0px;left:-300px;">Voltar</button></a>

            <form action="editar-pac.php" method="post" id="formPaciente">
                <h3 style="margin-left:140px;">Editar Paciente</h3>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" required id="convenio" name="convenio">
                        <?php
                ...
                <button type="submit" class="btn btn-info" name="btn_alterar_pac">Editar Paciente</button>
            </form>
        </div>
    </div>
</body>
